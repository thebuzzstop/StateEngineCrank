...
@brief:     UML Parsing
@details:   Locates UML in source code and parses for states, transitions
...
class UML(modules.Singleton.Singleton):
    ...
    # =========================================================================
    def add_enter(self, state, enter_func):
        """ Add state 'enter' function to list. """
        _mangle = self.mangle(state, enter_func)
    ...
    def add_do(self, state, do_func):
        ...
        _mangle = self.mangle(state, do_func)
        for _do in self.dos:
            if _mangle == _do:
                return
    ...
    def add_exit(self, state, exit_func):
        ...
        _mangle = self.mangle(state, exit_func)

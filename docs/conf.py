...
sys.path.insert(0, os.path.abspath('../source/BookMarks'))
...
htmlhelp_basename = 'StateEngineCrankdoc'
...
latex_documents = [
    (master_doc, 'StateEngineCrank.tex', 'StateEngineCrank Documentation',
     'Mark Sawyer', 'manual'),
]
...
man_pages = [
    (master_doc, 'stateenginecrank', 'StateEngineCrank Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'StateEngineCrank', 'StateEngineCrank Documentation',
     author, 'StateEngineCrank', 'One line description of project.',
     'Miscellaneous'),
]

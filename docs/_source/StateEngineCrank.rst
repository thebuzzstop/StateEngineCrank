...
* is generated by SEC when determined to be missing.

    .. rubric:: Example

    A state *do* function is specified as part of the UML and not found when SEC scans the user source file.

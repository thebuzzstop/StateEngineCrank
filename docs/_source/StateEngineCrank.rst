...
Subsequent versions of *The Crank* have been written in Ansi-C and Python by
`yours-truly <https://www.linkedin.com/in/markbsawyer/>`_.

.. centered:: *Crankin' them bits, boss.*
...
* is structural and is created from scratch every time *The Crank* is run.
...
* is generated by *The Crank* when determined to be missing.

    .. rubric:: Example

    A state *do* function is specified as part of the UML and not found when *The Crank* scans the user source file.

"""ClassProperty support

Lifted from https://github.com/david-salac/classutilities

Unable to install using 'pip' due to a Python version dependency error.
That raises some doubt whether this will work with Python 3.8
"""
